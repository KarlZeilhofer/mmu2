...
static const PinNr colorSelectorDirPin = A1; //color selector stepper motor (driven by trapezoidal screw)
...
static const PinNr chindaPin = 3;       // this switch was added on 10.1.18 to help with filament loading (X- signal on the RAMPS board)
...
static const PinNr greenLedPins[] = {0x100+7,0x100+15,0x100+13,0x100+11,0x100+9};
static const PinNr redLedPins[] =   {0x100+6,0x100+14,0x100+12,0x100+10,0x100+8};
